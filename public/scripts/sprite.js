...
const Sprite = function(ctx, x, y) {
    ...
    const drawSprite = function() {
        ...
        // sequence store the information of the object in png
        ctx.imageSmoothingEnabled = false; // avoid blurring after enlargement
        ctx.drawImage(sheet,sequence.x+sequence.width*index,sequence.y,sequence.width,sequence.height,
